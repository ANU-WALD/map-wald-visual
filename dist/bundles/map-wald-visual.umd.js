(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@angular/core'), require('@angular/forms'), require('@ng-bootstrap/ng-bootstrap'), require('@angular/common/http'), require('ngx-pipes'), require('@agm/core'), require('@angular/common'), require('map-wald'), require('store'), require('@agm/core/services/google-maps-types'), require('plotly.js/dist/plotly-basic'), require('rxjs/operators'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('map-wald-visual', ['@angular/core', '@angular/forms', '@ng-bootstrap/ng-bootstrap', '@angular/common/http', 'ngx-pipes', '@agm/core', '@angular/common', 'map-wald', 'store', '@agm/core/services/google-maps-types', 'plotly.js/dist/plotly-basic', 'rxjs/operators', 'rxjs'], factory) :
    (global = global || self, global['map-wald-visual'] = factory(global.ng.core, global.ng.forms, global.ngBootstrap, global.ng.common.http, global.ngxPipes, global.core$1, global.ng.common, global.mapWald, global.store, global.googleMapsTypes, global.plotlyBasic, global.rxjs.operators, global.rxjs));
}(this, function (core, forms, ngBootstrap, http, ngxPipes, core$1, common, mapWald, store, googleMapsTypes, plotlyBasic, operators, rxjs) { 'use strict';
    ...
    ngxPipes = ngxPipes && ngxPipes.hasOwnProperty('default') ? ngxPipes['default'] : ngxPipes;
    core$1 = core$1 && core$1.hasOwnProperty('default') ? core$1['default'] : core$1;
    ...
    googleMapsTypes = googleMapsTypes && googleMapsTypes.hasOwnProperty('default') ? googleMapsTypes['default'] : googleMapsTypes;
    plotlyBasic = plotlyBasic && plotlyBasic.hasOwnProperty('default') ? plotlyBasic['default'] : plotlyBasic;
    ...
    return mapWaldVisual$1;

}));
//# sourceMappingURL=map-wald-visual.umd.js.map
